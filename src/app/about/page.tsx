      ...
      <div className="w-full max-w-[1000px] animate-in">
        ...
        <div>
          ...
          <p className="opacity-60 font-medium mt-6">
            ...
            body fat percentage was to measure that person&apos;s average
            density (total mass divided by total volume) and apply a formula to
            convert that to body fat percentage. Since fat tissue has a lower
            density than muscles and bones, it is possible to estimate the fat
            content. This estimate is distorted by the fact that muscles and
            bones have different densities: for a person with a
            more-than-average amount of bone mass, the estimate will be too low.
            However, this method gives highly reproducible results for
            individual persons (± 1 to 3%). As measuring body density can be
            hard and costly, I had the idea to implement a machine learning
            model that is capable of predicting density given mesnurations.
          </p>
          <p className="opacity-60 font-medium mt-6">
          ...
          <p className="opacity-60 font-medium">
            ...
            your body. It&apos;s like a savings account for calories. Just as
            you put money in a savings account to use when you need it, your
            body stores calories as fat to use for energy later. Having some
            body fat is normal and healthy, but too much can cause health issues
            (contrarely to money in your bank account).
          </p>
          <p className="opacity-60 font-medium mt-6">
